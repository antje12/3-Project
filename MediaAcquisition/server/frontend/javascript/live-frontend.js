...
function getMetadata(link) {
    console.log("entered");
    fetch("http://manjaro.stream.stud-srv.sdu.dk/service01/getMetadata?youtubeLink=" + link, {
        method: "GET",
    })
...
function formSubmit() {
    ...
    fetch("http://manjaro.stream.stud-srv.sdu.dk/service01/saveMusic?youtubeLink=" + ytLink, {
        method: "POST",
        headers: {
